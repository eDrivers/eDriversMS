...
df[3,] <- c("Climate", "Sea bottom temperature", '~2 $km^2$', 'Monthly', '1981-2010 vs. 2013-2017', 'negative anomalies', '[@galbraith2018]','SBT-')
df[4,] <- c("Climate", "Sea bottom temperature", '~2 $km^2$', 'Monthly', '1981-2010 vs. 2013-2017', 'positie anomalies', '[@galbraith2018]','SBT+')
df[5,] <- c("Climate",  "Sea surface temperature", '~2 $km^2$', 'Monthly', '1981-2010 vs. 2013-2017', 'negative anomalies', '[@galbraith2018]','SST-')
df[6,] <- c("Climate", "Sea surface temperature", '~2 $km^2$', 'Monthly', '1981-2010 vs. 2013-2017', 'positive anomalies', '[@galbraith2018]','SST+')
...
df[16,] <- c("Climate", "Hypoxia", 'Lat/long', 'August-September', '2018', '$ml$ $L^{-1}$', '[@blais2019]','HYP')
