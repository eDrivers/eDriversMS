...
df[2,] <- c("Coastal", "Aquaculture", 'Lat/long', '-','Variable, between 1990-2016', '$presence-absence$','[@mapaq2016; @dfo2016a; @aaf2016; @fa2016; @ffa2016]','AQUA')
df[3,] <- c("Climate", "Bottom-water temperature", '~2 $km^2$', 'Monthly', '1981-2010 vs. 2013-2017', 'negative anomalies', '[@galbraith2018]','SBT-')
df[4,] <- c("Climate", "Bottom-water temperature", '~2 $km^2$', 'Monthly', '1981-2010 vs. 2013-2017', 'positie anomalies', '[@galbraith2018]','SBT+')
df[5,] <- c("Climate",  "Surface-water temperature", '~2 $km^2$', 'Monthly', '1981-2010 vs. 2013-2017', 'negative anomalies', '[@galbraith2018]','SST-')
df[6,] <- c("Climate", "Surface-water temperature", '~2 $km^2$', 'Monthly', '1981-2010 vs. 2013-2017', 'positive anomalies', '[@galbraith2018]','SST+')
...
df[15,] <- c("Coastal", "Direct human impact", 'Dissemination areas', 'Annual', '2016', 'population', '[@statistics-canada2017]','DHI')
df[16,] <- c("Climate", "Hypoxia", 'Lat/long', 'August-September', '2013-2017', '$ml$ $L^{-1}$', '[@blais2019]','HYP')
