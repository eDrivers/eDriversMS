...
\caption{\sout{Description of the Estuary and Gulf of St. Lawrence in Eastern Canada.}\textcolor{blue}{Description of the St. Lawrence System in Eastern Canada, composed of the St. Lawrence Estuary and the Gulf of St. Lawrence. The Estuary is defined by the limit of seawater intrusion, close to Îles d'Orléans, to the west and by its connection to the Gulf near Pointe-des-Monts. The Gulf is an interior sea connected to the Atlantic by Cabot Strait and the Strait of Belle Isle to the south and north of Newfoundland, respectively.}}
\label{egsl}
\end{figure}
