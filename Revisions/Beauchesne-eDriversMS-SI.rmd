...
Table S1. List of drivers currently available on *eDrivers* along with their respective acronym used in the figures in the supplementary material.
...
Oceans are the largest reservoir\textcolor{blue}{s} and sink\textcolor{blue}{s} of atmospheric carbon dioxide ($CO_2$).
Its uptake increases seawater acidity and \textcolor{red}{\sout{the}} lowers saturation state with
respect to calcite ($\Omega_C$) and aragonite ($\Omega_A$), the two most common
$CaCO_3$ polymorphs constituting the shells and skeleton\textcolor{blue}{s} of many marine
...
August-September of 2017 [@starr2019].
\textcolor{blue}{$\Omega_{A}$, pH, dissolved oxygen ($O_2$) and pressure were sampled at 117
...
The carbonate chemistry was determined
through pH and \textcolor{blue}{total alkalinity} (TA) measurements. Samples for pH and \textcolor{red}{\sout{total alkalinity}} TA were
collected under \textcolor{red}{\sout{a}} bubble free and no head space conditions into 500 $mL$
borosilicate glass flasks. 250 $\mu L$ of \textcolor{red}{\sout{the}} saturated $HgCl_2$ solution was
...
specifically designed for shallow end-point detection [@dickson2007]. The dilute\textcolor{blue}{d}
...
[@lewis1998] with measured pH, \textcolor{red}{\sout{total alkalinity}} \textcolor{blue}{TA}, soluble reactive
...
Such water masses \textcolor{red}{\sout{are}} have lower buffering capacities to decreasing pH and
...
Peninsula. $\Omega_A$ distribution in the Southern St. Lawrence was modeled
using the exponential kriging model.

We predicted $\Omega_A$ using $O_2$ for the Northern St. Lawrence. \textcolor{red}{\sout{Whereas}} \textcolor{blue}{While}
...
ranging between 0 and 1 that slowly \textcolor{red}{\sout{begins increasing}} \textcolor{blue}{increases} as $\Omega_A$ $\approx$
...
The data used to characterize hypoxia \textcolor{red}{\sout{uses oxygen saturation in % and}} come from
the Department of Fisheries and Oceans’ (DFO) Atlantic Zone Monitoring Program
[AZMP; @galbraith2018] survey\textcolor{red}{\sout{s}} in late spring and fall, as well as from \textcolor{red}{\sout{annual}}
