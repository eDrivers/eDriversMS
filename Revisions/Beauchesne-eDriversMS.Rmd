---
title: Next Generation Planning - Structuring and Sharing Environmental Drivers Data for the St. Lawrence System
...
<!--
rmarkdown::render('./Revisions/Beauchesne-eDriversMS.Rmd', 'pdf_document')
rmarkdown::render('./eDriversMS-v2.rmd', 'word_document')
-->
...
thus emerged in the process of addressing our initial goals: \textcolor{red}{\sout{sharing the knowledge gathered through the description of drivers in the St. Lawrence.}} \textcolor{blue}{sharing information about the distribution and intensity of drivers of change in the St.Lawrence.}
...
cumulative impact assessment initiative [@halpern2008a; @halpern2015a] \textcolor{blue}{and available from the National Center for Ecological Analysis and Synthesis (NCEAS) online data repository (Halpern et al. 2015)},
...
\textcolor{red}{\sout{We integrated datasets from regional experts and also use global data from the global cumulative impact assessment initiative [@halpern2008a; @halpern2015a]  available from the National Center for Ecological Analysis and Synthesis (NCEAS) online data repository [Table 1; @halpern2015].}} We selected global data that were
...
Drivers with non-normal frequency distributions were log-transformed,
\textcolor{blue}{as in Halpern et al. 2008, to minimize the impact of extreme outliers that may or may not be real observations} (Figure S1)\textcolor{blue}{,} and all drivers were scaled between 0 and 1 to allow driver comparisons. The 99th quantile of individual driver distribution was used as the upper bound for scaling \textcolor{red}{\sout{to control for extreme values and produce maps of individual drivers (Figure S2)}}. All drivers were embedded in a regular grid composed of 245604 $1 km^2$ hexagonal cells to construct the integrated dataset used for the
analyses \textcolor{blue}{(Figure S2)}.
...
\textcolor{blue}{The next step will be the inclusion of other types of knowledge to our initiative. Our focus has been on a single element required for fully operational impact assessments. Data that provide knowledge on the exposure of ecosystems to drivers are called stressor-based indicators (Dube and Munkittrick 2001; Dubé 2003; Jones 2016). These indicators efficently identify potential local impacts and can be proactively linked to decision-making, yet assume complete knowledge of drivers but fail to diagnose impacts on valued components or non-additive effects (Dube and Munkittrick 2001; Dubé 2003). In contrast, effect-based indicators are direct measurements of valued components (\textit{e.g.} species abundance and biodiversity) and inherently capture the effects of multiple drivers (Dube and Munkittrick 2001; Dubé 2003). Whereas effect-based indicators are considered superior to stressor-based indicators, they fail to ascribe observed effects to specific drivers (Dube and Munkittrick 2001; Dubé 2003). Stressor-based and effect-based indicators are, therefore, both required to diagnose causes of ecosystem change (Dube 2003; Jones 2016). As a collection of knowledge on stressor-based indicators, \textit{eDrivers} should be weaved with other, comparable, collections of knowledge describing valued ecosystem components that can be linked to drivers and allow for a better understanding of cumulative impacts. Ultimately, interdisciplinary colections of knowledge could be weaved together through social-ecological metanetworks analyses (Dee et al. 2016).}
...
<!-- !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! -->
TODO: Remove [@dube2001; @dube2003; @jones2016]
<!-- !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! -->
