...
The uncertainty associated with complex driver interactions must therefore be taken into account when investigating environmental impacts [@cote2016], yet most research on driver effects in marine environments remains overwhelmingly focused on single driver assessments [@obrien2019]. Increasing exposure and the experiences of past ecological tragedies such as the collapse of cod fisheries [@frank2005; @dempsey2018] and the decline of the beluga and right whale populations [@plourde2014] together urge the need to characterize the distribution, intensity and overlap between drivers in the St. Lawrence System. This will provide critical information on areas most exposed to \textcolor{red}{\sout{cumulative}} drivers \textcolor{red}{\sout{and on the interaction potential of drivers}} in the St. Lawrence. It is also a necessary step towards the holistic and integrated management of the St. Lawrence System.

\textcolor{blue}{Gathering knowledge is a major component of any holistic approach, which typically involve the selection and description of valued ecosystem component (\textit{e.g.} habitats or species) and driver indicators, the assessment of the exposure and vulnerability of valued components to drivers, the selection of a proper spatio-temporal scale, site monitoring, and public and stakeholder participation (Dubé and Munkittrick 2001).} <!-- [@dube2001] jones2016 ???? Noble2013??? -->
Gathering environmental \textcolor{red}{\sout{data}} \textcolor{blue}{knowledge} for large scale, \textcolor{red}{\sout{systematic}} \textcolor{blue}{holistic} initiatives can, however, be a very challenging and time consuming – not to say painful – process. On one hand, there is an overwhelming and expanding wealth of data available. Such information overload may inhibit our ability to make decisions based on scientific information, promote massive effort duplication, disproportionately appropriate research funds to certain sectors, and obscure knowledge gaps amid a sea of information [@eppler2004]. On the other hand, crucial data are lacking and remain largely unavailable or inaccessible for a variety of reasons, including proprietary rights, lack of organizational time, capacity and training, and in some rare cases unwillingness to share, curtailing our ability for appropriate decision-making.
...
\textcolor{blue}{As an introduction to indicators of cumulative exposure (objective 1), we begin by presenting a simplifed 2-driver example focusing on hypoxia and demersal destructive fisheries, two drivers known to occur mainly in deeper areas of the St. Lawrence. Driver co-ccurrence was evaluated spatially by summing the scaled intensity of drivers in each grid cell. The intensity at which pairs of drivers co-occur was evaluated using a two-dimensional kernel density estimate to investigate the relative intensity at which these two drivers typically co-occur.}
...
In order to \textcolor{red}{\sout{better capture potential interactions between drivers (objective 2) and to}}identify areas with similar exposure regimes (objective 3), we identify threat complexes using a clustering approach [*e.g.* see @bowler2019]. We use the term clusters in presenting the methods, but use threat complex when discussing the results on cumulative exposure regimes.
...
\textcolor{blue}{The individual or interactive effect of both drivers is thus species- and community-dependent and the co-occurrence of drivers in itself is not an evidence of driver interaction. Assuming that driver co-occurrence is a prerequisite for driver interactions, however, it is reasonable to expect interactions to occur in areas where both drivers co-occur at high relative intensities. }
...
\textcolor{red}{\sout{While the focus of our paper has been on the description of drivers in the St. Lawrence, drivers are but one of the 4 elements required to properly evaluate environmental impacts. This single knowledge node should be weaved with other, comparable, nodes required for integrated management approaches such as species distribution and marine protected areas. Ultimately, all of these knowledge nodes could be weaved together through social-ecological metanetworks (Dee et al. 2017).}}

\textcolor{blue}{A caveat to our initiative is that it focuses on a single element required for fully operational impact assessments. Data that provide knowledge on the exposure of ecosystems to drivers are called stressor-based indicators (Dube and Munkittrick 2001; Dubé 2003; Jones 2016). These indicators efficently identify potential local impacts and can be proactively linked to decision-making, yet assume complete knowledge of drivers and fail to diagnose impacts on valued components or non-additive effects (Dube and Munkittrick 2001; Dubé 2003). In contrast, effect-based indicators are direct measurements of valued components (*e.g.* species abundance and biodiversity) and inherently capture the effects of multiple drivers (Dube and Munkittrick 2001; Dubé 2003). While effect-based indicators are considered superior to stressor-based indicators, they fail to ascribe observed effects to specific drivers (Dube and Munkittrick 2001; Dubé 2003). Stressor-based and effect-based indicators are therefore both required to diagnose causes of ecosystem change (Dube 2003; Jones 2016). As a knowledge node on stressor-based indicators, *eDrivers* should be weaved with other, comparable, nodes describing valued ecosystem components that can be linked to drivers and allow a better understanding of cumulative impacts. Ultimately, multiple knowledge nodes could be weaved together through social-ecological metanetworks analyses (Dee et al. 2016).} <!-- [@dube2001; @dube2003; @jones2016; @dee2017] -->
