...
drivers exist, platforms collating comparable and interoperable knowledges on
...
structuring, standardizing and sharing knowledges on drivers in support of
...
impact assessment initiative [@halpern2008; @halpern2015], regional holistic
...
initiative [@halpern2008; @halpern2015] available from the National Center
for Ecological Analysis and Synthesis (NCEAS) online data repository
[Table 1; @halpern2015b]. We selected global data that were unavailable at the
...
dissimilarity. We used 100 iterations using samples of 10000 observations
...
dissimilarity [Figure S4; @clarke1993]. As the drivers dataset is too
...
cluster to better capture the inter-cluster dissimilarity. Analyses were
performed using the *vegan* R package [@oksanen2018].

### Intra-cluster similarity

Intra-cluster similarity was evaluated using the Bray-Curtis similarity index
(Figure S5). As with the inter-cluster dissimilarity, we used a
...
iterations. We however did not use the bootstraping procedure for clusters with
less than 10000 observations since computation time was manageable.
...
areas [e.g. @halpern2015; @feist2016; @mach2017; @stock2018]. These are areas
...
Basin, the most densely populated region in Canada [@statcan2017]. Most marine
...
growth rates [@dupont2013] and avoidance of oxygen-depleted habitats
...
application (https://david-beauchesne.shinyapps.io/eDriversApp/) to explore
drivers data interactively (Figure \ref{diag}).
...
[GOOS; http://www.goosocean.org]. As such, we will adopt the metadata standard
currently targetted for the upcoming CIOOS, *i.e.* the North American Profile
...
[see @reichman2011]. The platform will thus greatly facilitate the application
